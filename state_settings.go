...
func (s *SettingsState) Pushed(owner *state.Engine) error {
...
func (s *SettingsState) Popped(owner *state.Engine) error {
	return nil
}

func (s *SettingsState) Tick(dt float32) {
	// NOP
}

func (s SettingsState) GetName() string {
	return "Settings"
}
