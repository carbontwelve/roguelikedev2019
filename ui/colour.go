...
func LoadTheme(theme ColourTheme) {
	ColourAnsiWhite = theme.Colours["ColourAnsiWhite"]
	ColourAnsiBlack = theme.Colours["ColourAnsiBlack"]
	ColourAnsiBlue = theme.Colours["ColourAnsiBlue"]
	ColourAnsiGreen = theme.Colours["ColourAnsiGreen"]
	ColourAnsiCyan = theme.Colours["ColourAnsiCyan"]
	ColourAnsiRed = theme.Colours["ColourAnsiRed"]
	ColourAnsiPurple = theme.Colours["ColourAnsiPurple"]
	ColourAnsiYellow = theme.Colours["ColourAnsiYellow"]
	ColourAnsiGrey = theme.Colours["ColourAnsiGrey"]
	ColourAnsiLightBlue = theme.Colours["ColourAnsiLightBlue"]
	ColourAnsiLightGreen = theme.Colours["ColourAnsiLightGreen"]
	ColourAnsiLightCyan = theme.Colours["ColourAnsiLightCyan"]
	ColourAnsiLightRed = theme.Colours["ColourAnsiLightRed"]
	ColourAnsiLightPurple = theme.Colours["ColourAnsiLightPurple"]
	ColourAnsiLightYellow = theme.Colours["ColourAnsiLightYellow"]
	ColourAnsiLightGrey = theme.Colours["ColourAnsiLightGrey"]

	CurrentTheme = theme
}

func LinkColours() {
	ColourBg = ColourAnsiBlack
	ColourFg = ColourAnsiWhite
